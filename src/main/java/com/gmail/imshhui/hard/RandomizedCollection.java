 ...
 * collection.getRandom();
 *
 * @see <a href="https://leetcode.com/problems/insert-delete-getrandom-o1-duplicates-allowed/"></a>
 * User: liyulin
 * Date: 2019/11/6
 */
public class RandomizedCollection {
    private List<Integer> list;
    // Set<Integer> stores the index of <code>list</code> in the map
    ...
    public boolean remove(int val) {
        if (map.containsKey(val)) {
            ...
            // these two lines can not be opposite
            // bad case:
            ...
            // [[],[0],[0],[-1],[0],[],[],[],[],[],[],[],[],[],[]]
            lastValSet.add(index);
            lastValSet.remove(list.size() - 1);
